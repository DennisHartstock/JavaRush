...
public class Solution {
    ...
    static void fixDate(List<Date> brokenDates) {
        ...
        brokenDates.stream().filter(brokeDate -> brokeDate.after(current)).forEach(brokeDate -> {
            brokeDate.setYear(brokeDate.getYear() - 1900);
            brokeDate.setMonth(brokeDate.getMonth() - 1);
        });
    }
}
